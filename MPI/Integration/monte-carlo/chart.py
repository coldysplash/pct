...
def draw(filenames, labels):
    ...
    plt.figtext(0.23, 0.15, "(1x2)", fontsize=5, ha='center', va='center')
    plt.figtext(0.33, 0.15, "(1x4)", fontsize=5, ha='center', va='center')
    plt.figtext(0.43, 0.15, "(1x6)", fontsize=5, ha='center', va='center')
    plt.figtext(0.52, 0.15, "(2x4)", fontsize=5, ha='center', va='center')
    plt.figtext(0.61, 0.15, "(2x5)", fontsize=5, ha='center', va='center')
    plt.figtext(0.705, 0.15, "(2x6)", fontsize=5, ha='center', va='center')
    plt.figtext(0.805, 0.15, "(2x7)", fontsize=5, ha='center', va='center')
...
if __name__ == "__main__":
    draw(["data1.dat", "data2.dat"], ["n=10^7", "n=10^8"])